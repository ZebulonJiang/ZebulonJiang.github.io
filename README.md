...
```
# Site settings
title: Zebulon Blog             # title of your website
SEOTitle: Zebulon Blog			# check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: Zebulonpro     # modify this account to yours
...
It's possible that you want the two things different. For me, my site-title is **“Zebulon Blog”** but I want the title shows in search engine is **“黄玄的博客 | Zebulon Blog”** which is multi-language.
